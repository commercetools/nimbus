...
[← Back to Index](../component-guidelines.md) | [Next: Main Component →](./main-component.md)

## Purpose

Barrel export files (`index.ts` or `index.tsx`) define the public API of a component module. They control what consumers can import and establish clear module boundaries.
...
// Do NOT export internal types or components
// ❌ export { ButtonInternalHelper } from "./utils";
```
...
**Recommendation**: Be consistent within your component. Either always include extensions or never include them.
...
1. **Don't export internal utilities**
   ```typescript
...
2. **Don't mix export styles unnecessarily**
   ...
   export { SpecificType } from "./component.types";
   ```

3. **Don't create circular dependencies**
   ```typescript
   // ❌ Avoid circular imports
   export * from "./components"; // if components import from index
   ```
...
export * from "./component-name";
export * from "./component-name.types";
export * from "./hooks";  // Exposes all internal hooks
export * from "./utils";   // Exposes all utilities

// ✅ Good - selective exports
export { ComponentName } from "./component-name";
export type { ComponentNameProps } from "./component-name.types";
export { useComponentName } from "./hooks"; // Only if public API
```
...
export * from "./component.types"; // No extension
...
- [Compound Components](./compound-components.md) - Barrel exports for compound components

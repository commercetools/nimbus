...
[← Back to Index](../component-guidelines.md) | [Previous: Recipes](./recipes.md) | [Next: Compound Components →](./compound-components.md)

## Purpose

Slot component files (`{component-name}.slots.tsx`) create styled wrapper components that inject Chakra UI recipe context and apply CSS classes. They bridge React Aria components with the Nimbus styling system.
...
// ❌ WRONG - missing type exports
export const ButtonSlot = withContext("button", "root");
// Type not exported!
```
...
export const MenuContentSlot = withContext<HTMLDivElement, MenuContentSlotProps>(
  "div",
  "content"
);
...
const ButtonSlot = withContext("button", "root");

// ✅ Good - both type and component exported
export type ButtonSlotProps = HTMLChakraProps<"button">;
export const ButtonSlot = withContext<HTMLButtonElement, ButtonSlotProps>(
  "button",
  "root"
...
### 2. Wrong Context Function

```typescript
// ❌ Bad - using withContext for root
export const MenuRootSlot = withContext("div", "root");

// ✅ Good - using withProvider for root
...
```typescript
// ❌ Bad - styles not applied to React Aria component
<ButtonSlot>
  <RaButton />
</ButtonSlot>

// ✅ Good - asChild passes styles through
<ButtonSlot asChild>
  <RaButton />
</ButtonSlot>
```
...
export const ButtonWrapper = withContext("button", "root");
export const MenuSlotRoot = withProvider("div", "root");

...
- [ ] **Messages exported using named export: `export const messages = defineMessages({...})`**
...
- [ ] Component imports messages correctly using named import: `import { messages } from "./{component}.i18n"`

...
```jsx-live
const App = () => (
  <Select.Root aria-label="Select a fruit" data-testid="select" size="md" variant="outline">
    <Select.Options>
...
const App = () => {
  ...
  return (
    <Stack direction="horizontal" alignItems="center">
      {sizes.map(size => (
        <Select.Root size={size} key={size} aria-label="Select a fruit" data-testid="select" variant="outline">
          <Select.Options>
            <Select.Option>Apples</Select.Option>
            <Select.Option>Bananas</Select.Option>
            <Select.Option>Oranges</Select.Option>
  ...
  return (
    <Stack direction="horizontal" alignItems="center">
      {variants.map(variant => (
        <Select.Root variant={variant} key={variant} aria-label="Select a fruit" data-testid="select" size="md">
          <Select.Options>
            <Select.Option>Apples</Select.Option>
            <Select.Option>Bananas</Select.Option>
            <Select.Option>Oranges</Select.Option>
...
const App = () => {
  return (
    <Select.Root aria-label="Select some fruit(s)" data-testid="select" size="md" variant="outline">
        <Select.Options>

...
```jsx-live
const App = () => <Button size="md" variant="subtle" tone="neutral">I am a Button</Button>
```
...
```jsx-live
const App = () => <Button tone="primary" variant="solid" size="md" onPress={()=>alert()}>I am accessible</Button>
```
...
```jsx-live
const App = () => (
  <Button tone="primary" variant="solid" size="md" asChild>
...
```jsx-live
const App = () => <Button tone="primary" variant="solid" size="md" data-foo="bar">I can have data-attributes</Button>
```
  ...
  return (
    <Stack direction="horizontal">
      {variants.map(variant => (
        <Button tone="primary" key={variant} variant={variant} size="md">'{variant}' Button</Button>
      ))}
    </Stack>
  )
}
    ...
    <Stack>
      {colors.map((color) => (
        <Stack key={color} direction="horizontal">
          {variants.map((variant) => (
            <Button tone={color} key={variant} variant={variant} size="md">
              '{variant}' Button
            </Button>
          ))}
        </Stack>

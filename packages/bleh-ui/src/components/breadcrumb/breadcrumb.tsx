...
export type BreadcrumbRootType = React.ComponentProps<typeof BreadcrumbRoot>;
export type BreadcrumbLinkType = React.ComponentProps<typeof Breadcrumb.Link>;
export type BreadcrumbCurrentLinkType = React.ComponentProps<
  typeof Breadcrumb.CurrentLink
>;

export const BreadcrumbLink = (props: BreadcrumbLinkType) => (
  <Breadcrumb.Link {...props} />
);
export const BreadcrumbCurrentLink = (props: BreadcrumbLinkType) => (
  <Breadcrumb.CurrentLink {...props} />
);

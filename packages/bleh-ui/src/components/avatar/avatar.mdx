...
const App = () => (
  <Stack direction="horizontal">
    <Avatar firstName="John" lastName="Doe" size="md" src="https://thispersondoesnotexist.com/ " />
    <Avatar firstName="Jane" lastName="Smith" size="md" /> {/* Shows initials when no image */}
  </Stack>
)
```
...
const App = () => (
  <Stack direction="horizontal">
    <Avatar firstName="John" lastName="Doe" size="md"/> {/* Shows JD */}
  </Stack>
)
```

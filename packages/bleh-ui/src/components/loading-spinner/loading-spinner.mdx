...
const App = () => {
  ...
  return (
    <Stack direction="horizontal" alignItems="center">
      {sizes.map(size => (
        <LoadingSpinner key={size} size={size} tone="primary">'{size}' LoadingSpinner</LoadingSpinner>
      ))}
    </Stack>
  )
}
  ...
  return (
    <Stack direction="horizontal">
      {variants.map(variant => (
        <LoadingSpinner key={variant} variant={variant} tone="primary" size="sm">'{variant}' LoadingSpinner</LoadingSpinner>
      ))}
    </Stack>
  )
}
    ...
    <Stack>
      {colors.map((color) => (
        <Stack key={color} direction="horizontal">
          {variants.map((variant) => (
            <LoadingSpinner colorPalette={color} key={variant} variant={variant} size="sm">

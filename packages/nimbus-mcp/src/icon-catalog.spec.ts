...
const CATALOG_PATH = resolve(__dirname, "../data/icons.json");
const HAS_CATALOG = existsSync(CATALOG_PATH);
 ...
 *
 * Skipped when the catalog file is not present (e.g. CI without a prior build).
 */
describe.runIf(HAS_CATALOG)("icon catalog — structure", () => {
...
describe.runIf(HAS_CATALOG)("icon catalog — counts", () => {
...
describe.runIf(HAS_CATALOG)("icon catalog — spot checks", () => {

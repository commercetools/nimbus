...
PublicPageLayout is a pattern that composes Flex, Stack, and Heading into a
centered, full-viewport-height layout for public-facing pages. It replaces
the Merchant Center's `public-page-layout` component.

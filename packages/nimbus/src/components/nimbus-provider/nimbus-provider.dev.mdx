...
**Default behavior:**
- Loads Inter with weights 400, 500, 600, 700 (used by Nimbus design tokens)
...
If you're using Nimbus within Merchant Center or any application where app-kit/ui-kit already loads the Inter font, disable automatic font loading to avoid duplicates:

**Before (Nimbus loads fonts):**
```tsx

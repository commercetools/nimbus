...
description: A unified page layout component for both main-level and detail views, providing header with optional back navigation, scrollable content area, tab navigation, and optional footer. Replaces all eight MC page variants.

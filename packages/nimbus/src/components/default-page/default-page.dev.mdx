...
| Part | Description |
|------|-------------|
| `DefaultPage.Root` | Page container providing layout context and optional sticky variant props |
...
- [Storybook](https://nimbus-storybook.vercel.app/?path=/docs/patterns-pages-defaultpage--docs)

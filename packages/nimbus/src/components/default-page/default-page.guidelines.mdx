...
DefaultPage replaces all eight page components from Merchant Center Application
Kit (`@commercetools-frontend/application-components`):

**Main page components replaced:**
`InfoMainPage`, `FormMainPage`, `CustomFormMainPage`, `TabularMainPage`

**Detail page components replaced:**
`InfoDetailPage`, `FormDetailPage`, `CustomFormDetailPage`, `TabularDetailPage`

For detailed migration instructions, see the
[Migration guide](/components/layout/defaultpage/dev#migrating-from-merchant-center-application-kit)
...
and
[Components for Detail Pages](https://docs.commercetools.com/merchant-center-customizations/tooling-and-configuration/commercetools-frontend-application-components#components-for-detail-pages).

...
The `colorPalette` prop allows you to adapt the spinner to different backgrounds.
...
const App = () => (
  <Stack direction="row" gap="400">
    ...
    <Box padding="400" backgroundColor="black" borderRadius="4px">
...
These examples demonstrate how to test your implementation when using LoadingSpinner in your application. The component's internal functionality is already tested by Nimbus - these patterns help you verify your integration and application-specific logic.
...
describe('LoadingSpinner', () => {
  ...
  it('renders with a custom accessible label', () => {
    render(<LoadingSpinner aria-label="Loading products" />);
    
    expect(screen.getByRole('progressbar', { name: "Loading products" })).toBeInTheDocument();
  });
});
```

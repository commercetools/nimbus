...
```jsx-live
const App = () => (
  <Box backgroundColor="neutral.10" padding="400">
    <LoadingSpinner aria-label="Loading content" tone="white" />
  </Box>
)
```
...
This version will spin indefinitely as it is being shown.

```jsx-live
const App = () => <LoadingSpinner aria-label="Loading indefinitely" />
```
...
const App = () => (
  <Stack direction="row" gap="400" alignItems="center">
    <Button tone="primary" variant="solid" isDisabled>
      <LoadingSpinner size="xs" tone="white" aria-label="Saving" />
      Saving...
    </Button>
    <Button tone="primary" variant="solid" isDisabled>
      <LoadingSpinner size="xs" tone="white" aria-label="Processing" />
    </Button>
  </Stack>
)
```
...
const App = () => (
  <Button tone="primary" variant="solid">
    <LoadingSpinner size="xs" tone="white" aria-label="Remembering details" />
    Remembering details...
  </Button>
)
```

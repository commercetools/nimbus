...
title: Steps
description:
  A progress indicator with built-in navigation for multi-step processes like
  forms, wizards, and onboarding flows.
...
A progress indicator with built-in navigation that visually communicates the
user's position within a multi-step process such as forms, wizards, and
onboarding flows.

...
const App = () => (
  <Stack direction="row" gap="400">
    ...
    <Badge colorPalette="negative">Negative</Badge>
...
These examples demonstrate how to test your implementation when using Badge in your application. The component's internal functionality is already tested by Nimbus - these patterns help you verify your integration and application-specific logic.
...
### Testing with specific props

When using variants, you can verify the component renders with the expected content:

```tsx
import { render, screen } from '@testing-library/react';
import { Badge } from '@commercetools/nimbus';

describe('Badge with variants', () => {

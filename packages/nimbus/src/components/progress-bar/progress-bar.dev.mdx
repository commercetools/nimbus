...
These examples demonstrate how to test your implementation when using ProgressBar in your application. The component's internal functionality is already tested by Nimbus - these patterns help you verify your integration and application-specific logic.

### Basic rendering tests

Verify the component renders with the correct role and label:

```tsx
import { render, screen } from '@testing-library/react';
import { ProgressBar } from '@commercetools/nimbus';

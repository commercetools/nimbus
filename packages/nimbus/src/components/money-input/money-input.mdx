...
title: MoneyInput
description:
  A controlled input for money values that combines currency selection with
  amount input, supporting both standard and high-precision monetary values.
...
A controlled input for money values that combines currency selection with amount
input, supporting both standard and high-precision monetary values.

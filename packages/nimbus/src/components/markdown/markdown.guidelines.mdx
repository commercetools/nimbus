...
- **Pick the right trust level:** use the default `untrusted` posture for any
  AI- or user-generated content. Reserve `trusted` + `allowRawHtml` for content
  your team authors.
...
- **Don't** enable raw HTML for untrusted content.

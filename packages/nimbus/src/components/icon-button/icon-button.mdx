...
[TECH RELATED LINK](#) [TECH RELATED LINK](#)
...
| **Example**                                                                       | **Description**                                                                                                                                                                                 |
| --------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <Icons.Edit color="hsla(239, 58%, 56%, 1)" width="24px" height="24px" />          | Use for “edit”.                                                                                                                                                                                 |
| <Icons.FileUpload color="hsla(239, 58%, 56%, 1)" width="24px" height="24px" />    | Upload.                                                                                                                                                                                         |
| <Icons.FileDownload color="hsla(239, 58%, 56%, 1)" width="24px" height="24px" />  | Download.                                                                                                                                                                                       |
| <Icons.ViewColumn color="hsla(239, 58%, 56%, 1)" width="24px" height="24px" />    | “Table settings” Shows customizable elements for tables.                                                                                                                                        |
| <Icons.MoreVert color="hsla(239, 58%, 56%, 1)" width="24px" height="24px" />      | “More options” shows a list of other features or tools that are not primary or secondary actions. Usually paired with buttons in a button group. For consistency, use the vertical dot version. |
| <Icons.DragIndicator color="hsla(239, 58%, 56%, 1)" width="24px" height="24px" /> | “Drag” allows a user to drag elements to reorder.                                                                                                                                               |
| <Icons.Clear color="hsla(239, 58%, 56%, 1)" width="24px" height="24px" />         | Use for “remove”. This removes the relationship but does **not** delete this item completely.                                                                                                   |
| <Icons.Delete color="hsla(239, 58%, 56%, 1)" width="24px" height="24px" />        | Use for “delete”. This is a destructive action, removes item completely.                                                                                                                        |

#### Avoid these words

| **Avoid Icon/Concept**                                                                                                                                                                                                                                                                                                              | **Use this instead**                                                    |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------- |
| <Icons.Check color="hsla(239, 58%, 56%, 1)" width="24px" height="24px" /><Icons.CheckCircle color="hsla(239, 58%, 56%, 1)" width="24px" height="24px" />                                                                                                                                                                            | Use a button with “Save” instead of an icon button.                     |
| <Icons.MoreHoriz color="hsla(239, 58%, 56%, 1)" width="24px" height="24px" />                                                                                                                                                                                                                                                       | Use the vertical dot version to show more options.                      |
| <Icons.HighlightOff color="hsla(239, 58%, 56%, 1)" width="24px" height="24px" /><Icons.DeleteForever color="hsla(239, 58%, 56%, 1)" width="24px" height="24px" /><Icons.DoNotDisturb color="hsla(239, 58%, 56%, 1)" width="24px" height="24px" />                                                                                   | If using for the same function as “delete” use consistent icon above.   |
| <Icons.Upload color="hsla(239, 58%, 56%, 1)" width="24px" height="24px" /><Icons.CloudUpload color="hsla(239, 58%, 56%, 1)" width="24px" height="24px" /><Icons.Upgrade color="hsla(239, 58%, 56%, 1)" width="24px" height="24px" /><Icons.DriveFolderUpload color="hsla(239, 58%, 56%, 1)" width="24px" height="24px"/>            | If using for the same function as “upload” use consistent icon above.   |
| <Icons.ArrowCircleDown color="hsla(239, 58%, 56%, 1)" width="24px" height="24px" /><Icons.Download color="hsla(239, 58%, 56%, 1)" width="24px" height="24px" /><Icons.SimCardDownload color="hsla(239, 58%, 56%, 1)" width="24px" height="24px" /><Icons.CloudDownload color="hsla(239, 58%, 56%, 1)" width="24px" height="24px" /> | If using for the same function as “download” use consistent icon above. |

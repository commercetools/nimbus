...
day, and include start and end times.

### Resources

Deep dive on details and access design library

[Figma Link](https://www.figma.com/design/AvtPX6g7OGGCRvNlatGOIY/NIMBUS-design-system?node-id=4292-15537&m=dev)
...
- [W3C ARIA Date Picker Dialog](https://www.w3.org/WAI/ARIA/apg/patterns/dialog-modal/examples/datepicker-dialog/#accessibilityfeatures)(Date
  Picker)

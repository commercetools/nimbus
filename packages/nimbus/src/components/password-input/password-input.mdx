...
- **Forced complexity rules without explanation:** Avoid requiring complex
  ...
  user types.
- **As a default for single binary choices:** For simple "yes/no" or "on/off"
  settings related to security, use checkboxes or switches with clear labels
  instead.
...
const App = () => (
    <Box width="300px">
      <form autoComplete="on">
        <FormField.Root>
          <FormField.Label htmlFor="password-input">Password</FormField.Label>
          <FormField.Input>
            <PasswordInput
              id="password-input"
              name="password"
        ...
        <Box display="flex" justifyContent="space-between" alignItems="center" mt="100">
          <Button variant="link" colorPalette="primary" type="button">
            Forgot password
          </Button>
          <Button colorPalette="primary" variant="solid" type="submit">
            Submit
          </Button>
        </Box>
      </form>
...
- [Adobe Spectrum Design System](https://spectrum.adobe.com/page/password-field/)
- [React Spectrum](https://react-spectrum.adobe.com/react-spectrum/PasswordField.html)
- [W3C ARIA Authoring Practices Guide (APG)](https://www.w3.org/WAI/ARIA/apg/patterns/password-field/)

...
These examples demonstrate how to test your implementation when using Dialog in your application. The component's internal functionality is already tested by Nimbus - these patterns help you verify your integration and application-specific logic.

### Basic rendering tests

```tsx
import { render, screen } from '@testing-library/react';
import { Dialog } from '@commercetools/nimbus';
...
import { Dialog, Button } from '@commercetools/nimbus';
...
import { render, screen, waitFor } from '@testing-library/react';
import { userEvent } from '@testing-library/user-event';
import { Dialog, TextInput, Button } from '@commercetools/nimbus';

const FormDialog = ({ onSubmit }: { onSubmit: (data: { name: string }) => void }) => {

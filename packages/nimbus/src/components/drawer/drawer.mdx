...
Use `variant="fullscreen"` for a full-viewport drawer that fills the screen with a
small margin. This is ideal for complex editing workflows like form pages.

```jsx live
const App = () => (
  <Drawer.Root variant="fullscreen" placement="right">
    <Drawer.Trigger asChild>
      <Button>Open Fullscreen Drawer</Button>
    </Drawer.Trigger>
    <Drawer.Content>
      <Drawer.Header>
      ...
      <Drawer.Body>
        This drawer fills nearly the full viewport, providing a

...
The Grid component provides a powerful two-dimensional layout system for arranging content in rows and columns. It's a re-export of Chakra UI's Grid component, offering fine-grained control over layout, spanning, and custom grid behaviors.
  ...
  >
    <Grid.Item colSpan={{ base: 12, md: 8 }} rowSpan={2}>
      <Box p="400" bg="primary.7" h="full" borderRadius="md">
        ...
        <Text color="neutral.3">Primary analytics visualization</Text>
      </Box>
    </Grid.Item>
    <Grid.Item colSpan={{ base: 12, md: 4 }} rowSpan={2}>
      <Box p="400" bg="neutral.7" h="full" borderRadius="md">
        ...
        <Text color="neutral.3">Key metrics summary</Text>
      </Box>
    </Grid.Item>
  ...
  >
    <Grid.Item colSpan={2} rowSpan={2}>
      ...
      >
        ...
        <Text color="neutral.3">Premium collection highlight</Text>
      </Box>
    </Grid.Item>
    <Grid.Item colSpan={2}>
      <Box p="400" bg="neutral.7" h="full" borderRadius="md">
...
These examples demonstrate how to test your implementation when using Grid within your application. As the component's internal functionality is already tested by Nimbus, these patterns help you verify your integration and application-specific logic.

{{docs-tests: grid.docs.spec.tsx}}

...
A combobox is an input that combines a text field with a pop-up list of options. It allows users to filter for results and select a value from a predefined list.

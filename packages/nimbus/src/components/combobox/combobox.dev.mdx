...
const App = () => {
  ...
  return (
    <ComboBox.Root items={animals} aria-label="Select an animal">
      <ComboBox.Trigger />
      <ComboBox.Popover>
        <ComboBox.ListBox>
          {(item) => (
...
const App = () => {
  ...
  return (
    <Stack direction="column" gap="400">
      <ComboBox.Root size="sm" items={options} aria-label="Small combobox">
        <ComboBox.Trigger />
        <ComboBox.Popover>
          <ComboBox.ListBox>
            {(item) => (
      ...
      <ComboBox.Root size="md" items={options} aria-label="Medium combobox">
        <ComboBox.Trigger />
        <ComboBox.Popover>
          <ComboBox.ListBox>
            {(item) => (
...
const App = () => {
  ...
  return (
    <Stack direction="column" gap="400">
      <ComboBox.Root variant="solid" items={options} aria-label="Solid combobox">
        <ComboBox.Trigger />
        <ComboBox.Popover>
          <ComboBox.ListBox>
            {(item) => (
      ...
      <ComboBox.Root variant="ghost" items={options} aria-label="Ghost combobox">
        <ComboBox.Trigger />
        <ComboBox.Popover>
          <ComboBox.ListBox>
            {(item) => (
...
const App = () => {
  ...
  return (
    <ComboBox.Root items={options} isDisabled aria-label="Disabled combobox">
      <ComboBox.Trigger />
      <ComboBox.Popover>
        <ComboBox.ListBox>
          {(item) => (
...
const App = () => {
  ...
  return (
    <ComboBox.Root items={options} isInvalid aria-label="Invalid combobox">
      <ComboBox.Trigger />
      <ComboBox.Popover>
        <ComboBox.ListBox>
          {(item) => (
...
const App = () => {
  ...
  return (
    <ComboBox.Root items={foodCategories} aria-label="Select a food">
      <ComboBox.Trigger />
      <ComboBox.Popover>
        <ComboBox.ListBox>
          {(category) => (
  ...
  return (
    <Stack direction="column" gap="400">
      <Box>
        ...
        <ComboBox.Root items={options} menuTrigger="focus" aria-label="Focus trigger">
          <ComboBox.Trigger />
          <ComboBox.Popover>
            <ComboBox.ListBox>
              {(item) => (
      ...
      <Box>
        ...
        <ComboBox.Root items={options} menuTrigger="input" aria-label="Input trigger">
          <ComboBox.Trigger />
          <ComboBox.Popover>
            <ComboBox.ListBox>
              {(item) => (
      ...
      <Box>
        ...
        <ComboBox.Root items={options} menuTrigger="manual" aria-label="Manual trigger">
          <ComboBox.Trigger />
          <ComboBox.Popover>
            <ComboBox.ListBox>
              {(item) => (

...
- **Keyboard navigation**: Images are not focusable unless they are interactive (wrapped in a button or link)
...
- [Image Storybook](https://nimbus-storybook.vercel.app/?path=/docs/components-image--docs)

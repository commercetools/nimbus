...
```tsx
<Icon as={Icons.Info} color="primary.11" />
<Icon as={Icons.Warning} color="gold" />
```
...
```tsx
<Icon as={Icons.Settings} boxSize="2000" />
<Icon as={Icons.Home} boxSize="48px" />
```

...
While Icon is primarily designed for use with icons from `@commercetools/nimbus-icons`, you can also pass custom SVG elements as children. Note that for best results, custom SVGs should be structured similarly to the Nimbus icons:

...
```jsx-live
const App = () => <TextInput tone="primary" value="input value"/>
```
...
```jsx-live
const App = () => <TextInput tone="critical" isInvalid value="input value"/>
```
...
<GroupedPropsTable componentName="TextInput" />

...
The scrollbar can auto-hide when idle (default) or stay permanently visible.
With the default `hover` variant it appears on pointer entry or scrolling and
hides after a short idle delay; `variant="always"` keeps it visible.

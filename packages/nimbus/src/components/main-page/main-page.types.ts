...
export type MainPageProps = OmitInternalProps<MainPageRootSlotProps> & {
...
export type MainPageHeaderProps = OmitInternalProps<MainPageHeaderSlotProps> & {
  /** The header content (Title and/or Actions) */
  children?: React.ReactNode;
  ref?: React.Ref<HTMLElement>;
};

export type MainPageTitleProps = OmitInternalProps<MainPageTitleSlotProps> & {
  /** The page title text or element */
  children?: React.ReactNode;
  ref?: React.Ref<HTMLHeadingElement>;
};

export type MainPageActionsProps =
  OmitInternalProps<MainPageActionsSlotProps> & {
...
export type MainPageContentProps =
  OmitInternalProps<MainPageContentSlotProps> & {
...
export type MainPageFooterProps = OmitInternalProps<MainPageFooterSlotProps> & {

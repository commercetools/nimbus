 ...
 * within it project into those outlets. Reuse-or-create: if a `Region.Provider`
 * is already above this one, its registry is reused (so the namespace is shared
 ...
 * `Splitter` so a consumer can project into a pane. (The `Splitter` does this for
 * you; you only wrap it manually for non-Splitter usage.)
 */

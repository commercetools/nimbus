...
Include action buttons when users might want to undo or view details. Toasts with actions auto-dismiss after the standard duration (6 seconds by default).

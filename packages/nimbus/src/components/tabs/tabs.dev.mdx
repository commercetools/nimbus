...
The Tabs component can be used in two ways:

1. **Compound API** - Manual composition with `Tabs.Root`, `Tabs.List`, `Tabs.Tab`, `Tabs.Panels`, and `Tabs.Panel`
2. **Dynamic rendering** - Pass a `tabs` array prop to `Tabs.Root`

**Compound API approach:**

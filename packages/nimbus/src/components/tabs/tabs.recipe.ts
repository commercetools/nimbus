    ...
    variant: {
      ...
      pill: {
        ...
        tab: {
          ...highlightTabBase,
          borderRadius: "full",
          paddingLeft: "calc(var(--tabs-padding-left) + {spacing.50})",
          paddingRight: "calc(var(--tabs-padding-right) + {spacing.50})",
        },
      },
    },
    orientation: {
    ...
    size: {
      sm: {
        tab: {
          ...
          "--tabs-padding-top": "spacing.50",
          "--tabs-padding-right": "spacing.200",
          "--tabs-padding-bottom": "spacing.50",
          "--tabs-padding-left": "spacing.200",
        },
      },
      md: {
        tab: {
          "--tabs-font-size": "fontSizes.350",
          "--tabs-padding-top": "spacing.150",
          "--tabs-padding-right": "spacing.300",
          "--tabs-padding-bottom": "spacing.150",

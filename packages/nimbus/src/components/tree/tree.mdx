...
> [!NOTE]\
> Tree is **experimental**. There are no Figma specs yet — its visual styling is
> derived from existing list and accordion tokens and is pending design review.
> The component API is stable; spacing and visual details may still change.

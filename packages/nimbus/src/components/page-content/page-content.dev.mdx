...
const App = () => (
  <Stack direction="column" gap="800">
    <PageContent.Root variant="wide">
      <Box border="solid-25" borderColor="blue.6" padding="400" borderRadius="200">
        <Text color="blue.6" fontWeight="bold">wide</Text>
      </Box>
    </PageContent.Root>

    <PageContent.Root variant="narrow">
      <Box border="solid-25" borderColor="purple.6" padding="400" borderRadius="200">
        <Text color="purple.6" fontWeight="bold">narrow</Text>
      </Box>
    </PageContent.Root>

    <PageContent.Root variant="full">
      <Box border="solid-25" borderColor="teal.6" padding="400" borderRadius="200">
        <Text color="teal.6" fontWeight="bold">full</Text>
      </Box>
    </PageContent.Root>
  </Stack>
)
...
const App = () => (
  <Stack direction="column" gap="800">
    <PageContent.Root variant="wide" columns="1/1">
      <PageContent.Column>
        <Box border="solid-25" borderColor="blue.6" padding="400" borderRadius="200">
          <Text color="blue.6" fontWeight="bold">Left (equal)</Text>
        </Box>
      </PageContent.Column>
      <PageContent.Column>
        <Box border="solid-25" borderColor="purple.6" padding="400" borderRadius="200">
          <Text color="purple.6" fontWeight="bold">Right (equal)</Text>
        </Box>
      </PageContent.Column>
    </PageContent.Root>
    ...
    <PageContent.Root variant="wide" columns="2/1">
      <PageContent.Column>
        <Box border="solid-25" borderColor="teal.6" padding="400" borderRadius="200">
          <Text color="teal.6" fontWeight="bold">Main content (2fr)</Text>
        </Box>
      </PageContent.Column>
      <PageContent.Column>
        <Box border="solid-25" borderColor="orange.6" padding="400" borderRadius="200">
          <Text color="orange.6" fontWeight="bold">Sidebar (1fr)</Text>
        </Box>
      </PageContent.Column>
    </PageContent.Root>
  </Stack>
...
const App = () => (
  <PageContent.Root variant="wide" columns="2/1">
    <PageContent.Column>
      <Box border="solid-25" borderColor="blue.6" padding="400" borderRadius="200" minHeight="300px">
        <Text color="blue.6" fontWeight="bold">Main content area (tall)</Text>
      </Box>
    </PageContent.Column>
    <PageContent.Column sticky top="400">
      <Box border="solid-25" borderColor="purple.6" padding="400" borderRadius="200">
        <Text color="purple.6" fontWeight="bold">Sticky sidebar</Text>
      </Box>
    </PageContent.Column>
  </PageContent.Root>
)
...
const App = () => (
  <PageContent.Root variant="wide" columns="1/1" gap="1600">
    <PageContent.Column>
      <Box border="solid-25" borderColor="teal.6" padding="400" borderRadius="200">
        <Text color="teal.6" fontWeight="bold">Column 1</Text>
      </Box>
    </PageContent.Column>
    <PageContent.Column>
      <Box border="solid-25" borderColor="orange.6" padding="400" borderRadius="200">
        <Text color="orange.6" fontWeight="bold">Column 2</Text>
      </Box>
    </PageContent.Column>
  </PageContent.Root>
)

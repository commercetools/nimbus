  ...
  <Stack gap="800">
    <PageContent.Root variant="narrow">
      <Box bg="neutral.3" padding="600" borderRadius="200">
        <Stack gap="400">
          <Text fontWeight="bold">Narrow: Simple form</Text>
          <Text color="fg.subtle">Fields span the focused width.</Text>
        </Stack>
      </Box>
    </PageContent.Root>
    ...
    <PageContent.Root variant="wide">
      <Box bg="neutral.3" padding="600" borderRadius="200">
        <Stack gap="400">
          <Text fontWeight="bold">Wide: Complex form or small table</Text>
          <Text color="fg.subtle">More room for multi-section layouts.</Text>
        </Stack>
      </Box>
    </PageContent.Root>
    ...
    <PageContent.Root variant="full">
      <Box bg="neutral.3" padding="600" borderRadius="200">
        <Stack gap="400">
          <Text fontWeight="bold">Full: Large table</Text>
          <Text color="fg.subtle">Content spans the entire available width.</Text>
        </Stack>
      </Box>
    </PageContent.Root>
  </Stack>
...
const App = () => (
  <Stack gap="800">
    <PageContent.Root variant="full">
      <Box bg="neutral.3" padding="600" borderRadius="200">
        <Stack gap="400">
          <Text fontWeight="bold">Full: Simple form (avoid)</Text>
          <Text color="fg.subtle">This form does not need the full viewport width. Use narrow instead.</Text>
        </Stack>
      </Box>
    </PageContent.Root>
    ...
    <PageContent.Root variant="narrow">
      <Box bg="neutral.3" padding="600" borderRadius="200">
        <Stack gap="400">
          <Text fontWeight="bold">Narrow: Data table (avoid)</Text>
          <Text color="fg.subtle">Tables need more room. Use wide or full instead.</Text>
        </Stack>
      </Box>
    </PageContent.Root>
  </Stack>
...
const App = () => (
  <PageContent.Root variant="wide" columns="2/1">
    <PageContent.Column>
      <Box bg="primary.3" padding="600" borderRadius="200" minHeight="200px">
        <Stack gap="400">
...
const App = () => (
  <PageContent.Root variant="wide" columns="1/1">
    <PageContent.Column>
      <Box bg="neutral.3" padding="600" borderRadius="200">
        <Stack gap="400">
          <Text fontWeight="bold">Main form (avoid 1/1 for this)</Text>
          <Text color="fg.subtle">This content is more important than the sidebar. Use 2/1 to reflect the hierarchy.</Text>
        </Stack>
      </Box>
    </PageContent.Column>
    <PageContent.Column>
      <Box bg="neutral.3" padding="600" borderRadius="200">
        <Stack gap="400">
          ...
          <Text color="fg.subtle">Secondary content gets equal space unnecessarily.</Text>
        </Stack>
      </Box>
    </PageContent.Column>
  </PageContent.Root>
...
const App = () => (
  <Stack gap="800">
    <PageContent.Root variant="wide" columns="2/1">
      <PageContent.Column>
        <Box bg="primary.3" padding="600" borderRadius="200">
          <Text fontWeight="bold" color="primary.11">Wide: Form section</Text>
        </Box>
      </PageContent.Column>
      <PageContent.Column>
        <Box bg="purple.3" padding="600" borderRadius="200">
          <Text fontWeight="bold" color="purple.11">Sidebar</Text>
        </Box>
      </PageContent.Column>
    </PageContent.Root>
    ...
    <PageContent.Root variant="full">
      <Box bg="neutral.3" padding="600" borderRadius="200">
        <Text fontWeight="bold">Full: Data table section</Text>
      </Box>
    </PageContent.Root>
  </Stack>
)
  ...
  <Stack gap="800">
    <PageContent.Root variant="narrow">
      <Box bg="neutral.3" padding="400" borderRadius="200">
        <Text fontWeight="bold">Narrow section</Text>
      </Box>
    </PageContent.Root>

    <PageContent.Root variant="wide">
      <Box bg="neutral.3" padding="400" borderRadius="200">
        <Text fontWeight="bold">Wide section</Text>
      </Box>
    </PageContent.Root>

    <PageContent.Root variant="full">
      <Box bg="neutral.3" padding="400" borderRadius="200">
        <Text fontWeight="bold">Full section (three variants is too many)</Text>
      </Box>
    </PageContent.Root>
  </Stack>
)

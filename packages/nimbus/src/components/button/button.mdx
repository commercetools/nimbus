...
export const Tip = ({ icon, tipColor, tipBackgroundColor, children }) => (
  <div
    style={{
      backgroundColor: tipBackgroundColor,
      borderLeft: `4px solid ${tipColor}`,
      color: tipColor,
      padding: "20px 13px",
      display: "flex",
      gap: "11px",
  ...
  >
    <span style={{ color: "inherit", fontSize: "24px" }}>{icon}</span>
    {children}
  </div>
);
...
[Figma library](https://example.com) <a href="https://example.com"
style={{color: "blue"}}>Figma library</a>
...
| **Back**                                | This term typically implies a return to a previous state or location in a non-linear or less structured flow. It's often used for:<ul style={{listStyle: "disc"}}><li>Navigating browser history</li><li>Exiting a screen or section</li></ul>                                                                                           |
| **Previous**                            | This term is more common in linear, sequential flows, such as: <ul style={{listStyle: "disc"}}><li>Stepping through a list of items</li><li>Moving between pages in a paginated view</li><li>Progressing through a multi-step process</li></ul> <br />Pair “Previous” with “Next” button language.                                       |
| **Add new (noun)**                      | <ul style={{listStyle: "disc"}}><li>Establishes a new object from scratch. Always followed by an object. For example “add product” “add category”.</li><li>Can also be used in areas that establishes a new relationship. Example “add products to a category”.</li><li>Do not use “add new” as it does not give full context.</li></ul> |
...
<Tip tipColor="#46A557" tipBackgroundColor="#F4FAF5" icon={<Icons.Lightbulb />}>
  <>When to use</>
</Tip>
<br />
...
<Tip tipColor="#E5484D" tipBackgroundColor="#FFF5F5" icon={<Icons.Error />}>
  <>When not to use</>
</Tip>
<br />
...
<Tip tipColor="#46A557" tipBackgroundColor="#F4FAF5" icon={<Icons.Lightbulb />}>
  <div>
    ...
    <ul style={{ listStyle: "disc", marginLeft: "20px" }}>
      <li>
        Use the correct and consistently patterned icon for the action that a
        user will be selecting.{" "}
      </li>
      <li>
        Ok ways to break this rule are with drop downs and right pointing
        arrows.
      </li>
    </ul>
  </div>
...
<Tip tipColor="#E5484D" tipBackgroundColor="#FFF5F5" icon={<Icons.Error />}>
  <div>
    <strong>Don't</strong>
    <ul style={{ listStyle: "disc", marginLeft: "20px" }}>
      <li>Icons should represent the action the user will be taking.</li>
      <li>Don’t use two icons to represent an action. One icon will do.</li>
      <li>Left icons are the default unless there is directional reason.</li>
    </ul>
  </div>
</Tip>
<br />
...
<Tip tipColor="#46A557" tipBackgroundColor="#F4FAF5" icon={<Icons.Lightbulb />}>
  <div>
    ...
    <ul style={{ listStyle: "disc", marginLeft: "20px" }}>
      <li>
        Use right icons to build a drop down component with the Popover
        component.
      </li>
      <li>
        Icons are on the left unless there is a directional reason to use a
...
<Tip tipColor="#E5484D" tipBackgroundColor="#FFF5F5" icon={<Icons.Error />}>
  <div>
    <strong>Don't</strong>
    <ul style={{ listStyle: "disc", marginLeft: "20px" }}>
      <li>Dropdown icons should always be on the right side.</li>
      <li>
        Don’t place action describing icons on the right if a drop down is
        wanted.
      </li>
    </ul>
  </div>
...
<Tip tipColor="#E5484D" tipBackgroundColor="#FFF5F5" icon={<Icons.Error />}>
  <div>
    <strong>Don't</strong>
    <ul style={{ listStyle: "disc", marginLeft: "20px" }}>
      <li> Avoid stacking actions.</li>
      <li>Don’t use two filled primary toned buttons in the same area. </li>
    </ul>
  </div>
</Tip>
...
<Tip tipColor="#46A557" tipBackgroundColor="#F4FAF5" icon={<Icons.Lightbulb />}>
  <div>
    ...
    <ul style={{ listStyle: "disc", marginLeft: "20px" }}>
      ...
      <li>Outlined secondary button to the left of the primary action.</li>
      <li>Icon is on the left of the button.</li>
    </ul>
  </div>
</Tip>
...
<Tip tipColor="#E5484D" tipBackgroundColor="#FFF5F5" icon={<Icons.Error />}>
  <div>
    ...
    <ul style={{ listStyle: "disc", marginLeft: "20px" }}>
      <li>
        {" "}
        Do not place the filled primary button to the left of another
        option.{" "}
      </li>
      <li>Do not have two primary filled buttons near each other. </li>
      <li>Do not include punctuation in buttons </li>
    </ul>
  </div>
</Tip>
...
<Tip tipColor="#46A557" tipBackgroundColor="#F4FAF5" icon={<Icons.Lightbulb />}>
  <div>
    ...
    <ul style={{ listStyle: "disc", marginLeft: "20px" }}>
      <li>
        Expand actions should be placed at the lower center or left hand side of
        the element that will expand/collapse.
      </li>
      <li>Link button is using the correct size, 2x-small. </li>
    </ul>
  </div>
</Tip>
...
<Tip tipColor="#E5484D" tipBackgroundColor="#FFF5F5" icon={<Icons.Error />}>
  <div>
    <strong>Do</strong>
    <ul style={{ listStyle: "disc", marginLeft: "20px" }}>
      <li>The button is too large for this placement</li>
      <li>
        Expansion icons should be placed to the left side of the label to allow
        for easier scanning by a user.{" "}
      </li>
    </ul>
  </div>
</Tip>
...
The Button component uses onPress\* props to handle all user interactions—mouse
...
### Accessibility Standards
  ...
  **1. Perceivable:**
        - **Sufficient Color Contrast:**
          - **Text on Button:** The contrast ratio between the button text and the button background should be at least 4.5:1 for normal text and 3:1 for large text.
          - **Button to Background:** The contrast ratio between the button's background color and the surrounding page background should be at least 3:1.
        - **Visual Cues:**  Don't rely solely on color to convey information. Use additional visual cues like shapes, patterns, or text labels to ensure the button's meaning is clear to everyone, including people with color blindness.
        - **Focus Indicator:**  Provide a clear visual indicator when the button receives keyboard focus. This helps users understand which element is currently active.
          - **WCAG 2.2 has specific criteria for focus indicators:**
            - **2.4.11 Focus Not Obscured (Minimum) (Level AA):** The focus indicator must not be hidden by other content on the page.  
            - **2.4.13 Focus Appearance (Minimum) (Level AA):** The focus indicator must meet certain visibility requirements to be easily seen.    

  **2. Operable:**
        - **Keyboard Accessibility:** Buttons must be operable using a keyboard. Users should be able to navigate to the button using the Tab key and activate it using the Enter or Space key.  
        - **Target Size:**  Ensure that the button is large enough to be easily clickable, especially on touchscreens. WCAG recommends a minimum target size of 24x24 CSS pixels.
        - **Dragging Movements (2.5.7 Level AA):** If a button's function relies on dragging, an alternative method should be provided that doesn't require dragging.
         
  **3. Understandable:**
        - **Clear Labels:** The button's text label should clearly describe its function. 
        - **Consistent Design:**  Use buttons consistently throughout your website. This helps users learn the meaning of each button and makes it easier for them to navigate your site.
        - **Findable Help (3.2.6 Level A):**  If users might need help understanding how to use a button or what it does, provide clear and easily findable help resources.

  **4. Robust:**
        - **Assistive Technology Compatibility:** Ensure that buttons are compatible with assistive technologies like screen readers. This often involves using proper HTML markup and ARIA attributes to provide semantic information about the button.

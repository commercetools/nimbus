...
[Figma library](https://example.com)
...
| **Add new (noun)**                      | <ul><li>Establishes a new object from scratch. Always followed by an object. For example “add product” “add category”.</li><li>Can also be used in areas that establishes a new relationship. Example “add products to a category”.</li><li>Do not use “add new” as it does not give full context.</li></ul> |
...
- **Text on Button:** The contrast ratio between the button text and the button
...
- **2.4.11 Focus Not Obscured (Minimum) (Level AA):** The focus indicator must
  not be hidden by other content on the page.  

...
These examples demonstrate how to test your implementation when using Button in your application. The component's internal functionality is already tested by Nimbus - these patterns help you verify your integration and application-specific logic.
...
describe('Button interactions', () => {
  it('calls onPress handler when clicked', async () => {
    const user = userEvent.setup();
    const handlePress = jest.fn();
    
    render(<Button onPress={handlePress}>Action</Button>);
  ...
  it('does not call onPress when disabled', async () => {
    ...
    render(<Button isDisabled onPress={handlePress}>Action</Button>);

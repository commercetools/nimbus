  ...
  return (
    <Stack direction="column" gap="400">
      ...
      <Stack direction="row" gap="300">
        ...
        <Button size="sm" variant="secondary" onPress={() => setIsOpen(false)}>
          Close Menu
        </Button>
      </Stack>
      <Text fontSize="sm">
...
Pattern for actions that require different handling based on selection:
...
const App = () => {
  ...
  const handleAction = (id: string) => {
    const actionText = id === 'delete' 
      ? `Deleted ${selectedItems} items`
      : id === 'archive'
      ? `Archived ${selectedItems} items`
      : `Exported ${selectedItems} items`;
  ...
  return (
    <Stack direction="column" gap="400">
      ...
      <SplitButton
        ...
        icon={<Icons.Done />}
        isDisabled={selectedItems === 0}
      >
        <Menu.Item id="export">Export Selected</Menu.Item>
        <Menu.Item id="duplicate">Duplicate Selected</Menu.Item>
        <Menu.Item id="archive">Archive Selected</Menu.Item>
        <Menu.Item id="delete" isCritical>
          Delete Selected
        </Menu.Item>
      </SplitButton>
      {lastAction && (
        <Text fontSize="sm" color="success.11">
          ✓ {lastAction}
        </Text>
      )}
    </Stack>
...
- [Menu Component](/components/overlays/menu)

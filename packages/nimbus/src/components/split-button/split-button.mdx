...
The SplitButton component addresses the need for interfaces that
...
const App = () => {
  ...
  return (
    <SplitButton.Root actions={actions} />
  );
}
```
...
const App = () => {
  ...
  return (
    <Stack direction="row" gap="400" alignItems="center">
      <SplitButton.Root size="2xs" actions={actions} />
      <SplitButton.Root size="xs" actions={actions} />
      <SplitButton.Root size="md" actions={actions} />
    </Stack>
  );
}
```
...
const App = () => {
  ...
  return (
    <Stack direction="row" gap="400" wrap="wrap">
      <SplitButton.Root variant="solid" tone="primary" actions={actions} />
      <SplitButton.Root variant="subtle" tone="neutral" actions={actions} />
      <SplitButton.Root variant="outline" tone="info" actions={actions} />
    </Stack>
  );
}
```
...
const App = () => {
  ...
  return (
    <Stack direction="row" gap="400">
      <SplitButton.Root actions={enabledActions} />
      <SplitButton.Root isDisabled actions={disabledActions} />
    </Stack>
  );
}
```
...
const App = () => (
  <SplitButton.Root>
    <SplitButton.ButtonGroup>
      <SplitButton.Button onClick={() => alert('Account updated!')}>
        Update Account
      </SplitButton.Button>
      <SplitButton.DropdownTrigger />
    </SplitButton.ButtonGroup>
    <SplitButton.DropdownMenu>
      <SplitButton.MenuItem onClick={() => alert('Password changed')}>
        Change Password
      </SplitButton.MenuItem>
      <SplitButton.MenuItem onClick={() => alert('Data exported')}>
        Export My Data
      </SplitButton.MenuItem>
      <SplitButton.MenuItem onClick={() => alert('Account deactivated')}>
        Deactivate Account
      </SplitButton.MenuItem>
      <SplitButton.MenuItem
        isCritical
...
The SplitButton component is built with accessibility in mind,
...
const App = () => (
  <SplitButton.Root>
    <SplitButton.ButtonGroup>
      ...
      <SplitButton.DropdownTrigger aria-label="More sending options" />
    </SplitButton.ButtonGroup>
    <SplitButton.DropdownMenu>
      <SplitButton.MenuItem onClick={() => alert('Scheduled for later')}>
        Schedule Send
      </SplitButton.MenuItem>
      <SplitButton.MenuItem onClick={() => alert('Draft saved')}>
        Save as Draft
      </SplitButton.MenuItem>
      <SplitButton.MenuItem onClick={() => alert('Template created')}>
        Save as Template
      </SplitButton.MenuItem>
    </SplitButton.DropdownMenu>

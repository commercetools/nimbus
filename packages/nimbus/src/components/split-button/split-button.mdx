...
const App = () => (
  <Stack direction="horizontal" gap="400" wrap="wrap">
    <SplitButton variant="solid" colorPalette="primary" onAction={(id) => {}} aria-label="More actions">
      <Menu.Item id="action1">Action 1</Menu.Item>
      <Menu.Item id="action2">Action 2</Menu.Item>
    </SplitButton>
    <SplitButton variant="outline" colorPalette="primary" onAction={(id) => {}} aria-label="More actions">
      <Menu.Item id="action1">Action 1</Menu.Item>
      <Menu.Item id="action2">Action 2</Menu.Item>
    </SplitButton>
    <SplitButton variant="ghost" colorPalette="primary" onAction={(id) => {}} aria-label="More actions">
      <Menu.Item id="action1">Action 1</Menu.Item>
      <Menu.Item id="action2">Action 2</Menu.Item>
    </SplitButton>
  </Stack>
...
- **Visual Variants**: Multiple size, variant, and colorPalette options

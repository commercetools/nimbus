...
Customize the tag colors using the `colorPalette` prop:

```jsx-live-dev
const App = () => (
  <Stack direction="column" gap="400">
    <TagGroup.Root colorPalette="primary" aria-label="Primary tags">
      <TagGroup.TagList>
        <TagGroup.Tag backgroundColor="colorPalette.11">Primary</TagGroup.Tag>
        <TagGroup.Tag>Default</TagGroup.Tag>
      </TagGroup.TagList>
    </TagGroup.Root>

    <TagGroup.Root colorPalette="blue" aria-label="Blue tags">
      <TagGroup.TagList>
        <TagGroup.Tag>Blue</TagGroup.Tag>
        <TagGroup.Tag>Information</TagGroup.Tag>
      </TagGroup.TagList>
    </TagGroup.Root>

    <TagGroup.Root colorPalette="green" aria-label="Green tags">
      <TagGroup.TagList>
        <TagGroup.Tag>Green</TagGroup.Tag>
        <TagGroup.Tag>Success</TagGroup.Tag>
      </TagGroup.TagList>
    </TagGroup.Root>

    <TagGroup.Root colorPalette="red" aria-label="Red tags">
      <TagGroup.TagList>
        <TagGroup.Tag>Red</TagGroup.Tag>
        <TagGroup.Tag>Error</TagGroup.Tag>
      </TagGroup.TagList>
    </TagGroup.Root>
  </Stack>
)

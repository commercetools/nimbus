...
[TECH RELATED LINK](https://example.com)
[TECH RELATED LINK](https://example.com)
...
```jsx-live
const App = () => <Flex height="100px">
  <img src="/images/tooltip/tooltip-guideline-do.png" alt="tooltip do guideline" />
</Flex>
```
...
```jsx-live
const App = () => <Flex height="100px">
  <img src="/images/tooltip/tooltip-guideline-dont.png" alt="tooltip do guideline" />
</Flex>
```
...
Authors SHOULD ensure that elements with the <u>role</u> tooltip are referenced through the use of <u>aria-describedby</u> before or at the time the tooltip is displayed.

...
const App = () => (
  <Stack direction="column" gap="600">
    <Box>
      <Text fontWeight="600" mb="200">Sidebar layout:</Text>
      <Flex direction="row" gap="400" bg="neutral.3" p="400" borderRadius="200" height="2000">
        <Box p="400" bg="info.7" borderRadius="200" width="2000" flexShrink="0">
          Sidebar
        </Box>
    ...
    <Box>
      ...
      <Flex direction="row" gap="400" alignItems="center" bg="neutral.3" p="300" borderRadius="200">
        <Box width="600" height="600" bg="neutral.6" borderRadius="100" flexShrink="0">
          Logo
        </Box>
...
- [Storybook](https://nimbus-storybook.vercel.app/?path=/docs/components-flex--docs)
- [Chakra UI Flex Documentation](https://www.chakra-ui.com/docs/components/flex)

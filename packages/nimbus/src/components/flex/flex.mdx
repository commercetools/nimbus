...
Flex is a layout component that provides a convenient way to create flexible
layouts based on CSS Flexbox. It's based on the
[Chakra UI Flex component](https://chakra-ui.com/docs/components/flex) and

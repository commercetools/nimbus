...
- **Stacked depth**: Each nested ModalPage is slightly narrower to show visual hierarchy
...
own independent open state. Each stacked page is slightly narrower than the
one beneath it, providing a visual cue of the nesting depth.

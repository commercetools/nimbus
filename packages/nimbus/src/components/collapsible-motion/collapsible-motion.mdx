...
description:
  A compound component for creating smooth collapsible content with
...
A modern, accessible implementation of collapsible content with smooth height
animations. Built with React Aria for accessibility and Chakra UI for consistent
theming.
...
CollapsibleMotion follows WAI-ARIA guidelines for disclosure widgets and meets
WCAG 2.1 AA standards.

### Screen reader support


- Automatically applies proper ARIA attributes (`aria-expanded`,
  `aria-controls`)
...
- **2.1.1 Keyboard**: Full keyboard navigation support through standard button
  interactions
...
- **4.1.2 Name, Role, Value**: Proper ARIA attributes (`aria-expanded`,
  `aria-controls`) communicate state and relationships

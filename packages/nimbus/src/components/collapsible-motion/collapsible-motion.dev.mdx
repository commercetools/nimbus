---
title: CollapsibleMotion Component
  ...
  <CollapsibleMotion.Root defaultExpanded={false}>
    ...
    <CollapsibleMotion.Content>
      <Box p="400" bg="neutral.2" borderRadius="200">
        <Text>This content smoothly expands and collapses</Text>
      </Box>
    </CollapsibleMotion.Content>
      ...
      >
        ...
        <CollapsibleMotion.Content>
          <Box p="400" bg="blue.2" borderRadius="200">
            <Text>Collapsible content area with smooth animations</Text>
          </Box>
        </CollapsibleMotion.Content>
      </CollapsibleMotion.Root>
...
const App = () => {
  ...
  const content = {
    ...
    long: 'This is very long content that shows how CollapsibleMotion automatically re-measures content height when it changes. The component uses ResizeObserver to detect size changes and smoothly animate to the new height, ensuring a polished user experience even with dynamic content.',
  };
  ...
  const faqs = [
    {
      ...
      answer: 'CollapsibleMotion is a compound component that provides smooth expand/collapse animations with full accessibility support via React Aria.',
    },
    {

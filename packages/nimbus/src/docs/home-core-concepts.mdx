...
Nimbus aims to provide a comprehensive suite of accessible and pre-themed React
components, enabling developers to build beautiful and consistent user
interfaces with ease, however, it's important to understand the following underlying
concepts to make the most of the system.

...
| Stage                         | Description                     | API Stability                                | Testing       | Production Use                 |
| ----------------------------- | ------------------------------- | -------------------------------------------- | ------------- | ------------------------------ |
| **Experimental**              | Early-stage implementation      | No guarantees, may be removed without notice | Minimal       | Not recommended, feedback only |
| **Alpha**                     | Core functionality implemented  | Likely to change significantly               | Basic         | Not recommended                |
| **Beta**                      | Feature complete implementation | Largely stabilized, may still change         | Comprehensive | With caution                   |
| **Release Candidate (RC)**    | Fully implemented               | Frozen except for critical issues            | Complete      | Safe                           |
| **General Availability (GA)** | Production-ready                | Stable with semantic versioning              | Thorough      | Fully supported                |
| **Deprecated**                | No longer recommended           | No changes except critical fixes             | Maintained    | Not for new projects           |

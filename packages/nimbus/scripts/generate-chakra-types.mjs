...
async function main() {
  console.log(
    "🎨 Generating Chakra UI type augmentations for Nimbus theme...\n"
  );
  ...
  try {
    ...
    console.log(`\n✅ Generated ${generatedFiles.length} type files\n`);
 ...
 *
 * This file is generated by scripts/generate-chakra-types.mjs
...
`);
    ...
    for (const filename of Object.keys(GENERATED_FILES)) {
      ...
      if (!fs.existsSync(filePath)) {
        console.warn(`⚠️  Warning: Expected file not found: ${filename}`);
        continue;
      }
    ...
    console.log("✅ Done! Type augmentations are ready.\n");
  } catch (error) {

  ...
  color: {
    ...
    "brand-palettes": {
      ...
      ctviolet: {
        ...
        "4": {
          value: {
            _light: "hsl(231, 100%, 95%)",
            _dark: "hsl(244, 54%, 28%)",
          },
        },
        "5": {
          value: {
            _light: "hsl(231, 100%, 92%)",
            _dark: "hsl(243, 49%, 34%)",
          },
        },
        "6": {
          value: {
            _light: "hsl(233, 100%, 89%)",
            _dark: "hsl(241, 44%, 39%)",
          },
        },
        "7": {
          value: {
            _light: "hsl(233, 100%, 85%)",
            _dark: "hsl(241, 42%, 46%)",
          },
        },
        "8": {
          value: {
            _light: "hsl(235, 100%, 79%)",
            _dark: "hsl(241, 50%, 55%)",
          },
        },
        "9": {
          value: {
            _light: "hsl(244, 100%, 67%)",
            _dark: "hsl(244, 100%, 67%)",
          },
        },
        "10": {
          value: {
            _light: "hsl(244, 76%, 61%)",
            _dark: "hsl(245, 84%, 61%)",
          },
        },
        "11": {
          value: {
            _light: "hsl(245, 71%, 58%)",
            _dark: "hsl(234, 100%, 82%)",
          },
        },
        "12": {
          value: {
            _light: "hsl(243, 52%, 28%)",
            _dark: "hsl(230, 100%, 93%)",
          },
        },
        DEFAULT: {
          value: {
          ...
          value: {
            ...
            "2": {
              value: {
                ...
                _dark: "hsla(234, 100%, 70%, 0.13)",
              },
            },
            "3": {
              value: {
                _light: "hsla(229, 100%, 50%, 0.07)",
                _dark: "hsla(241, 100%, 68%, 0.3)",
              },
            },
            "4": {
              value: {
                _light: "hsla(230, 100%, 50%, 0.11)",
                _dark: "hsla(244, 100%, 65%, 0.44)",
              },
            },
            "5": {
              value: {
                _light: "hsla(230, 100%, 50%, 0.16)",
                _dark: "hsla(243, 100%, 67%, 0.51)",
              },
            },
            "6": {
              value: {
                _light: "hsla(232, 100%, 50%, 0.23)",
                _dark: "hsla(241, 100%, 69%, 0.57)",
              },
            },
            "7": {
              value: {
                _light: "hsla(233, 100%, 50%, 0.31)",
                _dark: "hsla(241, 100%, 70%, 0.65)",
              },
            },
            "8": {
              value: {
                _light: "hsla(235, 100%, 50%, 0.42)",
                _dark: "hsla(240, 100%, 71%, 0.78)",
              },
            },
            "9": {
              value: {
                _light: "hsla(244, 100%, 50%, 0.65)",
                _dark: "hsl(244, 100%, 67%)",
              },
            },
            "10": {
              value: {
                _light: "hsla(244, 100%, 43%, 0.69)",
                _dark: "hsla(245, 100%, 65%, 0.94)",
              },
            },
            "11": {
              value: {

...
5. Reference `pnpm openspec list` or `pnpm openspec show <item>` when additional
   context is required.

**Reference**

- Use `pnpm openspec show <id> --json --deltas-only` if you need additional
context from the proposal while implementing.
<!-- OPENSPEC:END -->

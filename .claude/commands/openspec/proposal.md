...
1. Review `openspec/project.md`, run `pnpm openspec list` and
   `pnpm openspec list --specs`, and inspect related code or docs (e.g., via
...
7. Validate with `pnpm openspec validate <id> --strict` and resolve every issue

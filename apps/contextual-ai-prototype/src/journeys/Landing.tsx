...
const journeys = [
  {
    ...
    steps: [
      ...
      { selector: "[data-tour='variants-table']", title: "Variants: API data + AI suggestions", description: "The variants table shows 3 existing variants (API data) alongside 3 AI-suggested ones. Navy/256GB, Green/128GB, White/512GB each have a ✦ provenance indicator and a \"Create\" button. Lena clicks Create on the first two. The readiness score climbs.", renderTarget: "augmentation" as const, placement: "bottom" as const, action: "highlightStars" as const },

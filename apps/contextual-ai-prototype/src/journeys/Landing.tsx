...
const journeys = [
  {
    ...
    accent: "teal",
    steps: [
      { selector: "[data-tour='inline-slot']", title: "Lena checks readiness", description: "Lena opens the product page. The Product Enrichment Agent reads from the locators on the page being rendered to understand the context: this is a product detail view for Galaxy S25 Ultra. It assembles a readiness scorecard automatically: 68% launch readiness. No prompt needed.", renderTarget: "inline" as const, placement: "bottom" as const },
      ...
      { selector: "[data-tour='chat-panel']", title: "Lena asks a follow-up question", description: "The panel has context because locators on the page let the agent infer specifics about the view being rendered, augmented by the user's interactions (category selections, readiness state, variant data). No blank prompt. Lena asks about EU variants and gets a structured response immediately.", renderTarget: "panel" as const, placement: "left" as const, action: "openPanel" as const },
    ],
  },
  {
    id: 2,

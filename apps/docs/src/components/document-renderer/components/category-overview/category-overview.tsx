...
import { documentationAtom } from "@/src/atoms/documentation";
import { Box, Card, Heading, Stack, Text } from "@commercetools/nimbus";
import { DocLink } from "@/src/components/navigation/doc-link";
